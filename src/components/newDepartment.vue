 ...
 * @LastEditTime: 2021-05-07 23:41:56
    ...
    <el-container>
      <el-aside :span="12">
        <el-col>
          <el-menu
            router
            default-active="/super/newDepartment"
      ...
      <el-main>
        <el-form ref="newDepartment" :model="newDepartment" label-width="80px">
          ...
          <el-form-item label="部门简介">
            <el-input
              type="textarea"
              v-model="newDepartment.describes"
            ></el-input>
          </el-form-item>
          <el-form-item>
...
export default {
  data() {
    return {
      dialogVisible: false,
      newDepartment: { describes: '', departmentName: '' },
      departments: []
    }
  },
  async created() {
